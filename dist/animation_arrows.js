...
class MainApp {
    ...
    _loadArrowsTest() {
        ...
        this.group_arrows_parent = new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Group();

        this.group_arrows_svg = new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Group();
    ...
    _initArrowsTest_ColorGradient() {
        ...
        // test coloring
        const gradient_test = new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Gradient([
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(1, 0, 1, 1), 0.0],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(1, 0, 0, 1), 0.05],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(0, 1, 0, 1), 0.06],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(1, 1, 0, 1), 0.49],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(0, 0, 1, 1), 0.5],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(1, 1, 0, 1), 0.51],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(1, 0, 0, 1), 0.94],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(0, 1, 0, 1), 0.95],
            [new __WEBPACK_IMPORTED_MODULE_1_paper___default.a.Color(0, 1, 1, 1), 1.0],
        ]);
    ...
    _initArrowsTest_Animation() {
        ...
        this.animation_arrows_loop = new __WEBPACK_IMPORTED_MODULE_3__animation_multi__["b" /* MultiAnimation */]({
            group: step5_layer,
...
//# sourceMappingURL=animation_arrows.js.map